...
const Footer = () => {
  return (
    <footer className="text-white mt-20 h-full my-auto">
      <div className="-mb-0.5 w-full my-auto">
        <svg
      ...
      <div className="bg-gradient-to-b from-[#ac2acc] via-[#d47fbc] to-[#d7384d] my-auto">
        <div className="container px-5 py-20 mx-auto w-full">
          <div className="w-full flex flex-wrap gap-10 items-center justify-between -mb-10 -px-4">
                ...
                <div className="mb-10 flex flex-col gap-3">
                  {links.map((link, index) => (
                    <Link
                      key={link + index}
                      to="/"
                      className="text-gray-200 text-md hover:text-white "
                    >
                      {link}
                    </Link>
                  ))}
        ...
        <div className="bg-gradient-to-b from-[#d64968] to-[#d3162f]">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row font-semibold">
            <p className="text-gray-300 text-md  text-center sm:text-left">
              &copy; Become Hushher with —
              <a
                href="https://hush1one.com/"
            ...
            <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-300 text-sm">
              Designed & Developed by Hushh.ai
            </span>
          </div>
        </div>
      </div>
