...
import { Home } from "../../public/images/index.js";
    ...
    <div className="">
      ...
      >
        <div className="w-full z-10">
          ...
          <div className="w-full flex items-center justify-around bg-white px-2 md:px-5 py-2 md:py-3 shadow-lg shadow-red-100 rounded-full">
            <SearchInput
            ...
            <div>
              <CustomButton
                ...
                title="Search"
                containerStyles={
                  " py-2 md:py-3 px-3 md:px-10 focus:outline-none bg-gradient-to-r from-[#ac2acc] via-[#d47fbc] to-[#d7384d] text-white hover:scale-[95%] rounded-full md:rounded-md text-lg md:text-lg"
                }
              />
            </div>
          </div>
          ...
          {type && (
            <div className="w-full lg:1/2 flex flex-wrap gap-3 md:gap-6 py-10 md:py-14">
              {popularSearch.map((search, index) => (
                <span
                  key={index}
                  className="bg-[#1d4fd826] text-[#ad0f98]  py-1 px-3 rounded-full text-lg"
                >
                  {search}
                </span>
              ))}
        ...
        <div className="hidden lg:block absolute w-1/3 h-full  top-24 md:-top-6 lg:-top-0 right-16 2xl:right-[18rem]">
