...
import { CustomButton, JobCard, ListBox, HighlightedText } from "../components";
...
const FindJobs = () => {
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      setData(res?.data);
      console.log("Find jobPage Data: ", res?.data);
  ...
  const filterExperience = async (e) => {
    if (expVal?.includes(e)) {
      setExpVal(expVal?.filter((el) => el != el));
    } else {
      setExpVal([...expVal, e]);
    }
  };
  ...
  return (
    <div>
      <Header
        title={<HighlightedText text="Become HUSSHER" />}
        type="home"
