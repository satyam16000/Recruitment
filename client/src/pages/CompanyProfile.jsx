...
import { UpdatedUser, Login } from "../redux/userSlice";
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (res.status === "failed") {
        ...
        const updatedCompany = { ...res.company, token: user?.token };
        dispatch(UpdatedUser(res?.company));
        dispatch(Login(updatedCompany));
        localStorage.setItem("userInfo", JSON.stringify(updatedCompany));
    ...
    <div className="container mx-auto p-5">
      <div className="">
        <div className="w-full flex flex-col md:flex-row gap-3 justify-between">
          ...
          {user?.accountType === "company" && info?._id === user?._id && (
